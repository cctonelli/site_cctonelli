...
// Using the updated compatible fork
          ...
          <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleAddInsight} className="bg-slate-800/20 border border-white/5 p-10 rounded-[2.5rem] space-y-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-950/50 rounded-3xl overflow-hidden border border-white/10 min-h-[400px]">
                      <Suspense fallback={<div className="p-20 text-center text-slate-600 italic">Inicializando editor seguro...</div>}>
                        <ReactQuill 
                          theme="snow" 
            ...
            {activeTab === 'store' && (
              <div className="space-y-12 animate-in fade-in">
                ...
                {/* Product form and list logic here */}
              </div>
            )}
