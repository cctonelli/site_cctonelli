...
const TestimonialsSection: React.FC<TestimonialsSectionProps> = ({ testimonials, language }) => {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          {testimonials.map((test) => (
            <div key={test.id} className="relative p-12 bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-white/5 reveal shadow-2xl">
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-blue-500 uppercase tracking-widest font-bold">
                      Partner at {test.company || 'Private Equity'}
                    </p>
                  </div>
                </div>
              </div>
