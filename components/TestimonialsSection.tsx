      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          {testimonials.map((test) => (
            <div key={test.id} className="relative p-12 bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-white/5 reveal active shadow-2xl">
              ...
              <div className="relative z-10 space-y-8">
                <p className="text-xl text-slate-600 dark:text-slate-300 font-light italic leading-relaxed">
                  "{resolveTranslation(test.id, 'quote', test.quote)}"
                </p>
