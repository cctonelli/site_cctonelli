        ...
        <div className="flex items-center gap-4 lg:gap-8">
          ...
          <div className="relative group/user">
            <button 
              ...
              className="bg-blue-600 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-blue-500 transition-all shadow-2xl shadow-blue-600/30 active:scale-95 flex items-center gap-3"
            >
              {userProfile ? (
                <>
