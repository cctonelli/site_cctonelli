...
const ProductPage: React.FC<ProductPageProps> = ({ language, t, resolveTranslation }) => {
  ...
  const renderBlock = (block: ProductContentBlock) => {
    ...
    switch (block_type) {
          ...
          <section key={block.id} className="pt-48 pb-64 relative bg-black overflow-hidden border-b border-white/5 min-h-[90vh] flex items-center">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 md:gap-10">
                  <a href="#precos" className="text-black px-12 md:px-20 py-6 rounded-2xl font-black uppercase tracking-[0.4em] text-[10px] md:text-[12px] shadow-2xl transition-all hover:scale-110 active:scale-95" style={{ backgroundColor: blockColor, boxShadow: `0 20px 60px ${blockColor}50` }}>
      ...
      case 'comparison':
        return (
          <section key={block.id} id="precos" className="py-48 md:py-64 bg-[#010309] relative border-y border-white/5">
